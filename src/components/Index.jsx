                ...
                <div className="container zoom-in-animate">
                    <div className="row justify-content-center">
                        <div className="offset-3 col-lg-8">
                            ...
                            <p>I'm a &nbsp;
                                <span ref={el} className="typed" data-typed-items="Software Developer, Senior Backend Engineer, Python Backend Developer (FastAPI), PHP Laravel Developer, DevOps Engineer (Docker | Terraform | Ansible), Cloud / Infrastructure Engineer"></span>
